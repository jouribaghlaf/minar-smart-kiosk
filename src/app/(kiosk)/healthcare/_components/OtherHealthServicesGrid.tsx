...
import { Building2, Video, ClipboardCheck, Syringe, Truck } from "lucide-react";
    ...
    <div className="rounded-card border border-cream-200 bg-white p-5 shadow-card">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
        {[
          ...
          { icon: Video, ar: "الاستشارات عن بعد", en: "Remote Consultations" },
          { icon: ClipboardCheck, ar: "مراكز الفحص", en: "Checkup Centers" },
          { icon: Syringe, ar: "التطعيمات", en: "Vaccinations" },
