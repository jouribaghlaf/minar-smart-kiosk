...
import { ArrowLeft, ArrowRight, BookOpenCheck, QrCode } from "lucide-react";
...
export function PersonalizedExperienceCard() {
  ...
  return (
    <aside className="relative flex flex-col gap-5 overflow-hidden rounded-card bg-brand-900 p-6 text-white shadow-card-hover">
      ...
      <div><h2 className="text-kiosk-lg font-bold">{t("دخول مخصص وآمن", "Secure personalized access")}</h2><p className="mt-1.5 text-kiosk-xs text-white/70">{t("استرجع بيانات رحلتك باستخدام الجواز أو بطاقة نسك", "Retrieve your journey using your passport or Nusuk card")}</p></div>
