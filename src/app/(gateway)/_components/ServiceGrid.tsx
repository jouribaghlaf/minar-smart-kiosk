...
const SERVICES: ServiceDefinition[] = [
  ...
  { slug: "field-help", requiresSignIn: true, icon: MapPinCheck, ar: "الإرشاد للتائهين", en: "Lost Pilgrim Guidance", descriptionAr: "طلب مرشد ميداني ومتابعة وصول المساعدة", descriptionEn: "Request and track field guidance" },
  ...
  { slug: "udhiyah", requiresSignIn: true, icon: Utensils, ar: "خدمة الأضاحي", en: "Adahi Service", descriptionAr: "اختيار النسك والدفع وإصدار السند", descriptionEn: "Choose, pay, and issue an electronic receipt" },
